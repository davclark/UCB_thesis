...
% Note something about whether the route is with retrospective awareness /
% episodic memory or without, the change is still conceptual. Link to Tse, et
% al.'s result of non hippocampal dependent consolidation.
...
\nptextcite{aggleton_interleaving_2006} for an overview of relevant theories and
...
% A graphical representation of this relationship is depicted in
% Figure~\ref{fig:causal-two}.
...
On its own, this result would be insufficient to make strong claims about
...
(\nptextcite{munnich_numerically-driven_2004} and \nptextcite{ranney_designing_2008}, also focused, to
