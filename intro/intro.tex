...
We then look at effects. That's a solid 4 sections.
...
human-caused)––and as it is thus behavioral, it will be "solved" only by changes
in human behavior. The IPCC (Intergovernmental Panel on Climate Change) and
Skeptical Science have assembled and disseminated the scientific consensus on
GW, but, sadly, the U.S. public remains divided on both the existence and the
