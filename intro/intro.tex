...
education is not effective, and some argue that it is \emph{counter}-effective.
However, as with many failures to observe a result in the behavioral sciences,
it may simply be that effective science education here, as in many cases, is
is simply very hard. However, as we'll see below, there are many examples of the
...
While \textcite{hoffman} has suggested the metaphor of smoking as a useful
