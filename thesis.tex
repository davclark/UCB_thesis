...
% Oh fussiness! Note that we don't need to include the microtype package
% \newfontfeature{Microtype}{protrusion=default;expansion=default;}

% Numbers=OldStyle can only be used on the regular Pagella font
...
% 
% \setmonofont[Microtype]{TeX Gyre Heros}
% 
...
% Also - folks seem to think polyglossia is better now...
