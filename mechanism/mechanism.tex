...
we noted numerous potential shotcomings of such studies, such as the exclusion
...
items recieved a “mechanistic” code on the pretest (including incorrect codes;
...
\caption{Stated party affiliation for the 12 of 36 individuals for whom we have
    ...
    “democrat” and “republican.” Similary, three “democrats” shifted away, while
...
completed the  “full sandwich” or a “partial pretest.” Note that
demographics were \emph{also} collected following the primary intervention,
because we did not have them for all participants. Thus, for some participants,
we collected some demographic information twice (some of which is reported on
below).
...
This range of delays prior to this test was used to assess the timecourse of
retention in planning subsequent studies. We lack the power to test forgetting
over time here, but we did not observe any numerically.
...
to delayed was not signifiant). These are plotted in
...
\begin{figure}
    ...
    \caption{Objectively scored knowledge before and after our intervention.
        ...
        an individual over time, it is interesting to note that earlier
...
\begin{figure}
    ...
    \caption{Reported global warming (GW) beliefs and attitudes before and after
        ...
        mean of 6.2.  We can also notice here that all of the lowest-rating
        individuals took the delayed test quite early. We should certainly be
        taking those initial dips with a grain of salt. We cannot assume that's
