...
\caption{Summary of “improvement” results for college classroom interventions.
...
\caption[]{Improvements in college classroom interventions, continued}\\
\toprule
Result & {$p$-value} & Statistic \\ \midrule
\endhead
...
% Final \\ necessary to compile!
\caption{Summary of individual and group differences for college classroom
...
% The empty option prevents a TOC entry from being generated
\caption[]{Individual and group differences in college classroom interventions,
    continued}\\
\toprule
Result & {$p$-value} & Statistic \\ \midrule
\endhead
...
group's post-test answers for know1	&	0.0002453	&	$t(82.91) = -383$
(paired)	\\
...
% Final \\ necessary to compile!
\caption{Summary of relationships between variables for college classroom
    interventions. All results were \emph{a priori} unless description starts
...
% The empty option prevents a TOC entry from being generated
\caption[]{Relationships between variables in college classroom interventions,
    continued}\\
\toprule
Result & {$p$-value} & Statistic \\ \midrule
\endhead
...
correlation between re-reading and posttest objective knowledge scores. NB: we
...
reduces post-hoc rationalization and hindsight bias. (On surprise, see
Chapter~\ref{chap:two}; Munnich, Ranney, \& Song, 2007.) A graphical depiction of the
