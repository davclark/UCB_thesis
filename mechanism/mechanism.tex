...
% In general, gains were fairly consistent across all “gw” measures, ranging
% only down to 0.11 at the lowest (the über-greenie “humans are severely abusing
% the environment”). Interestingly importance of lifestyle changed the most
% (0.27 – though this was not included in the tested average gw variable).
% Expectation of engagement, dishearteningly, clocks in at a 0.05 DROP! Enter
% motivational interventions like Oroeco?
...
significant (actually in hypotheses.pdf currently)	&	0.014	&	$t(78.7) =
2.23$ (Welch)	\\
\bottomrule
\end{tabular}
    \caption{Summary of results for colleg classroom interventions}
    \label{table:summary-classroom}
\end{table}
