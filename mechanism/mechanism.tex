...
\begin{figure}
    ...
    \caption{Surprise ratings for individuals in Study 2. The shape of both of
        ...
        In particular, both conditions here yield surpise values in the 7+
        range.  Thus, it seems to matter less if or when participants recieve
        the beliefs and attitutdes surveys---the higher surprise values appear
...
\emph{Self-rated} knowledge is significantely correlated with scored knowledge on the
...
failed to exceed our significance threshold (4.5, $p=.11$). These scores are
