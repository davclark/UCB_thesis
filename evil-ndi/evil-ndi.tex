...
\begin{figure}[h]
    ...
    \caption{An overview of experimental flows for our “evil” NDI experiment. If
        ...
        recieved no pretest).  Flow for NDI experiments in
...
mean of 5.0 on the pretest to 4.5 for the two-item group (12\% of available
...
\begin{figure}
    ...
    \caption{Self-rated knoweldge for individuals on pre and posttests. Again,
